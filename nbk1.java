...
import java.sql.*;
import java.io.*;
class nbk1 extends JFrame implements ActionListener
{
	JDesktopPane jdp=new JDesktopPane();
	
	JLabel luser= new JLabel("Enter User Name");
	...
	nbk1()
	{
	super("Book Login Screen");
	add(jdp);
	jdp.setLayout(null);
	luser.setBounds(20,20,100,100);
	jdp.add(luser);
	tuser.setBounds(150,20,150,50);
	jdp.add(tuser);
	lpass.setBounds(20,100,100,50);
	jdp.add(lpass);
	tpass.setBounds(150,100,150,50);
	jdp.add(tpass);
	btn1.setBounds(300,300,100,20);
	jdp.add(btn1);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
		JInternalFrame jf=new JInternalFrame("BOOK STORE",true,true,true,true);
		...
		JInternalFrame jf2=new JInternalFrame(bookname,true,true,true,true);
		...
		jf2.add("East",panelb);
		panelb.add(txt5);
		jf2.add("North",panelc);
		panelc.add(l9);
		panelb.add(btn1);
		
		jf2.add("Center",paneld);
...
{
JInternalFrame jf3=new JInternalFrame("PURCHASE",true,true,true,true);
