...
import javax.swing.*;
import java.sql.*;
class Book13 extends JFrame implements ItemListener,ActionListener
{
	...
	public void itemStateChanged(ItemEvent e)
		...
		void actionPerformed(ActionEvent ae)
		{
			...
			{
				JInternalFrame jf2=new JInternalFrame("Payment Details",true,true,true,true);
				jf2.setVisible(true);
				jdp.add(jf2);
			}
		}
